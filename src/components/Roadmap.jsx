...
const roadmapData = [
  ...
  {
    version: "Маленьке оновлення баг-фікси",
    status: "done",
    size: "small",
    date: "Випущено",
    description:
  ...
  items: [
    { text: "Відкриття Енду", done: false },
    { text: "Нові блоки та механіки Енду", done: false },
  ...
  size: "small",
  date: "У планах",
  description: "Додавання нових с/г культур, купа нової їжі та кулінарних механік.",
  items: [
    { text: "Нові сільськогосподарські культури", done: false },
    { text: "Традиційні українські страви", done: false },
    { text: "Система консервації та заготовок", done: false },
    { text: "Нові кулінарні блоки та механіки", done: false },
    { text: "Декоративний посуд та кухонне начиння", done: false },
    { text: "Українські сільські структури", done: false },
    { text: "Нові біоми з унікальною флорою", done: false },
    { text: "Система напоїв та бродіння", done: false },
  ],
  },
  {
